...
//------
#define HEATER_CRITICAL_TEMP 320.0 // when to halt everything for emergency shutdown
#define HEATER_STOP_TEMP 280.0 // when to shut off the heaters
#define HEATER_START_TEMP 275.0 // below this number we start the heaters
#define HEATER_NOT_READY_TEMP 240.0 // below this number we notify the user to stop
